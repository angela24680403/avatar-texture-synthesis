...
public class ScreenshotMaskAvatar : MonoBehaviour
{
    private static ScreenshotMaskAvatar instance;
    ...
    private void OnPostRender()
    {
        if (takeScreenshotOnNextFrame)
        {
            ...
            System.IO.File.WriteAllBytes(Application.dataPath + "/Captured-Screenshots/Mask/screenshot" + captureCount.ToString() + ".png", byteArray);
